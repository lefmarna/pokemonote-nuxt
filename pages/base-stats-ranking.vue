...
export default defineComponent({
  setup() {
    updateMeta(
      '種族値ランキング',
      'ポケモンSVの種族値ランキングです。DLC「ゼロの秘宝 - 碧の仮面」に登場する新ポケモンにも対応！ 攻撃や特攻、素早さを除いた実質種族値でのリストアップも可能です。伝説や幻のポケモンを表示するオプション、各種ステータスでソートする機能も用意しています。準伝や600属の暴れる環境で、採用するポケモンに迷った際には、きっとこのツールが役立つことでしょう。'
    )
