<template>
  <v-container class="my-0 px-sm-4">
    ...
    <p>
      本利用規約は、<nuxt-link to="/">Pokemonote</nuxt-link
    ...
    <p>当サイトでは<nuxt-link to="/lefmarna-otoiawase">お問い合わせフォーム</nuxt-link>を設けています。</p>
    <p>訪問者がお問い合わせフォームから問い合わせをされた際に入力された、以下の個人情報を取得します。</p>
    <ul>
    ...
    <h4>個人情報取得の同意について</h4>
    <p>当サイトでは、お問い合わせフォームからお問い合わせをする前に、当利用規約をご一読いただくよう案内しています。</p>
    ...
    <p>当該第三者によって取得されたCookie情報等は、当該第三者の利用規約に従って取り扱われます。</p>
    ...
    <p>
      上記を希望される場合は、<nuxt-link to="/lefmarna-otoiawase">お問い合わせフォーム</nuxt-link
      >にてお問い合わせください。
    </p>
    ...
    <p>
      訪問者は、広告設定で訪問者に合わせた広告（以下、「パーソナライズド広告」とします。）を無効にすることが出来ます。その設定をする場合は、<a
        ...
        rel="noopener noreferrer"
        >こちらをクリック</a
      >してください。また、<a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer"
        >www.aboutads.info</a
      >
